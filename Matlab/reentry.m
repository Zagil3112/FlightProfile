function xprime = reentry(t,x);

global gamma g0 rho0 hscale Re Ma15C subs trans a b c d e f A_talos Th_talos mdot_talos omega epsilon Lc_capsule A_capsule
