...
vEast = v_over100.*cos(phi_over100).*sin(Azimut_over100);
vDown= -1*v_over100.*sin(phi_over100);
...
Tabelle = table(h_100,tiempo_over100,delta_over100,lamda_over100, phi_over100, ...
    v_over100,Azimut_over100,h_over100,radio_over100,x_2,y_2,z_2,vNorth,vEast,vDown,Vx,Vy,Vz);
...
writetable(Tabelle2,'Vector de Estado2.csv');
